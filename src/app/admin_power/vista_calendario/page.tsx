...
import MonthlyTimelineCalendar from './MonthlyTimelineCalendar';

// Interfaces copied from calendario/page.tsx
...
const VistaCalendarioPageContent: React.FC = () => {
...
const VistaCalendarioPage: React.FC = () => {
  return (
    <Suspense fallback={
      ...
      <VistaCalendarioPageContent />
    </Suspense>
  );
};

export default VistaCalendarioPage; 